...
from preprocess import SNLI
from Pyramid_Model3 import Pyramid_Model3
...
def train(lr, w, l2_reg, epoch, batch_size, model_type, num_layers, data_type, num_classes=3, genre = "telephone"):
    ...
    model = Pyramid_Model3(s=max_len, w=w, l2_reg=l2_reg, model_type=model_type, embeddings = embedding_weight,
